package com.example.gpsbasedprofiling.provider;
...
import static com.example.gpsbasedprofiling.provider.PlaceContract.PlaceEntry;
...
public class PlaceContentProvider extends ContentProvider {
    ...
    private static final String TAG = com.example.gpsbasedprofiling.provider.PlaceContentProvider.class.getName();
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        // Add URI matches
        uriMatcher.addURI(com.example.gpsbasedprofiling.provider.PlaceContract.AUTHORITY, com.example.gpsbasedprofiling.provider.PlaceContract.PATH_PLACES, PLACES);
        uriMatcher.addURI(com.example.gpsbasedprofiling.provider.PlaceContract.AUTHORITY, com.example.gpsbasedprofiling.provider.PlaceContract.PATH_PLACES + "/#", PLACE_WITH_ID);
        return uriMatcher;
    }

    // Member variable for a PlaceDbHelper that's initialized in the onCreate() method
    private com.example.gpsbasedprofiling.provider.PlaceDbHelper mPlaceDbHelper;

    @Override
    public boolean onCreate() {
        Context context = getContext();
        mPlaceDbHelper = new com.example.gpsbasedprofiling.provider.PlaceDbHelper(context);
        return true;
    }
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        ...
        switch (match) {
            case PLACES:
                ...
                if (id > 0) {
                    returnUri = ContentUris.withAppendedId(com.example.gpsbasedprofiling.provider.PlaceContract.PlaceEntry.CONTENT_URI, id);
                } else {
