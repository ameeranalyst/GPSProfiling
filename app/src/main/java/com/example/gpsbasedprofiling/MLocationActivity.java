...
import com.example.gpsbasedprofiling.provider.PlaceContract;
...
public class MLocationActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LoaderManager.LoaderCallbacks<Cursor>{

    // Constants
    public static final String TAG = MLocationActivity.class.getSimpleName();
    ...
    public void onAddPlaceButton(View view) {
        if (ActivityCompat.checkSelfPermission(MLocationActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
    ...
    protected void onResume() {
        ...
        if(ActivityCompat.checkSelfPermission(MLocationActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED){
...
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
    ...
    public void onLocationPermissionClicked(View view){
        ActivityCompat.requestPermissions(MLocationActivity.this,
